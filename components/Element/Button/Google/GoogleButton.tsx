...
const GoogleButton = () => {
  ...
  //   redirect_uri: `${locationOrigin}/auth/google/callback`,
  //   response_type: "code",
  // };
  // const googleCodeURL = `https://accounts.google.com/o/oauth2/auth?${new URLSearchParams(
  //   googleParam
  // ).toString()}`;
  ...
  const googleCodeURL = "https://api.tikitaka.chat/oauth2/authorization/google";
  return (
    <Button
      onClick={() => {
        window.location.href = googleCodeURL;
      }}
      href={googleCodeURL}
    >
      <svg
